...
class AboutDialog(wx.Dialog):
    def __init__(self, parent, id):
        ...
        self.sizer1 = wx.BoxSizer(wx.VERTICAL)
        self.sizer1.Add(wx.StaticText(self, -1, u"Concrete compressive strength"),
                        0, wx.ALIGN_CENTER_HORIZONTAL | wx.TOP, border=20)
...
class App(wx.App):
    ...
    def OnInit(self):
        self.version = u""
        self.title = u"Concrete compressive strength prediction software v1.0" + self.version
